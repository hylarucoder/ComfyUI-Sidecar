...
fn stats_repo(path: &str) -> Result<(), Box<dyn std::error::Error>> {
...
fn git_clone(repo_url: &str, path: &str) -> Result<(), Box<dyn std::error::Error>> {
...
fn git_pull(repo_path: &str) -> Result<(), Box<dyn std::error::Error>> {
